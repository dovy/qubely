...
class QUBELY
{
    ...
    public function init_menu_pages() {
        // Load Pages
        require_once QUBELY_DIR_PATH . 'core/Options.php';
        require_once QUBELY_DIR_PATH . 'core/Getting_Started.php';

        // Load Classes
        $this->getting_started = new Qubely_Getting_Started();
        $this->options = new QUBELY_Options();
    }
